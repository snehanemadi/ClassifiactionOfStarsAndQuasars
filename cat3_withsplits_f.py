...
def confusion_matrix(act,pred):
    ...
    print("recall:" + repr(recall * 100))
    print("precision:" + repr(precision * 100))
    #print("f-score:" + repr(f_score * 100))
    print("error rate:" + repr(error_rate*100))
...
for x in range(len(test)):
    ...
    #print(predictions)
    #print('> predicted=' + repr(result) + ', actual=' + repr(test[x][14]))

accuracy = getAccuracy(test, predictions)
print('Accuracy: ' + repr(accuracy) + '%')
actual = []
for i in range(len(test)):
    actual.append(test[i][12])
